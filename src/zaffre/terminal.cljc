...
(defprotocol Terminal
  ...
  (replace-chars! [this layer-id buffers] "Replaces the characters in a layer. `characters is an array of arrays where each element is a map and must have these keys: :c - character or keyword, :fg [r g b] :bg [r g b] where r,g,b are ints from 0-255.")
  #_(set-fg! [this layer-id x y fg] "Changes the foreground color of a character in a layer.")
  #_(set-bg! [this layer-id x y bg] "Changes the background color of a character in a layer.")
